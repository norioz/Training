...
// The class Student should have two data members : marks, which is an array
// of size 6 and cur_id. It has two member functions : getdata and putdata.
// The function getdata should get the input from the user : the name, age, 
// and the marks of the student in 6 subjects. The function putdata should 
...
// created. If the first line of input for each object is 1, it means that
// the object being created is of the Professor class, you will have to input
// the name, age and publications of the professor.
// If the first line of input for each object is 2, it means that the object
// is of the Student class, you will have to input the name, age and the marks
// of the student in 6 subjects.
//
// Output
...
// the sum of the marks in 6 subjects and id on a new line.
//
// Sample
// 4
// 1
